    ...
    const fetchProperty = async () => {
      ...
      try {
        ...
        if (Array.isArray(parsedAmenities)) {
          amenitiesArr = parsedAmenities;
        } else if (parsedAmenities && typeof parsedAmenities === "object") {
          // if object, convert to array of {name,description} heuristically
          amenitiesArr = Object.keys(parsedAmenities).map((k) => ({ name: k, description: parsedAmenities[k] || "" }));
        }
        ...
        const details = buildSafeDetails(data.details ?? data.property_details ?? data.detail);
