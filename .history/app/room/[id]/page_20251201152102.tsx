    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-medium flex items-center gap-2">
          {property.owner_name}
          {/* If you have a verified column later, use it here */}
          {/* <CheckCircle className="w-4 h-4 text-green-600" /> */}
        </div>

        {/* You can remove these if not in DB */}
        <div className="text-sm text-gray-500">Joined recently</div>
      </div>
    </div>

    {/* If you don't have responseTime in DB, keep static text */}
    <div className="text-sm text-gray-600">Usually responds quickly</div>
