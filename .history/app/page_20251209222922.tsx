    ...
    async function loadFeaturedRooms() {
      try {
        ...
        if (Array.isArray(data.properties)) {
          setFeaturedRooms(data.properties)
        } else {
          setFeaturedRooms([])
        }
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Students के लिए बना एक trusted platform — room, domestic helper और
              complete details सब कुछ एक ही जगह।
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Students के लिए specially designed features
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center p-6">
                <CardContent>
                  ...
                  <h3 className="text-xl font-semibold mb-2">Smart Search</h3>
                  <p className="text-gray-600">
                    Location, price, room type और sharing options से exact match
                    पाएं
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6">
                <CardContent>
                  ...
                  <p className="text-gray-600">
                    सभी properties और owners verified हैं — no fake tension
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6">
                <CardContent>
                  ...
                  <p className="text-gray-600">
                    Cooking की चिंता खत्म — experienced Maushi available
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  Students के लिए बना trusted room rental platform
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li>
                    <Link href="/saved">Saved Rooms</Link>
                  </li>
                  <li>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>
                &copy; 2025 RoomFinder. All rights reserved. Made with
                ❤️ for Students
              </p>
            </div>
          </div>
