  ...
  useEffect(() => {
    ...
    const fetchHelper = async () => {
      ...
      try {
        ...
        if (imgs.length === 0) {
          if (data.profile_photo) imgs.push(data.profile_photo);
          else imgs = ["/placeholder.svg"];
        }
        ...
        const normalized = {
          ...
          images: imgs,
          specialties: Array.isArray(specialtiesArr) ? specialtiesArr : [specialtiesArr],
          services: Array.isArray(servicesArr) ? servicesArr : [servicesArr],
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-6 mb-6">
                  <Badge variant="outline" className="flex items-center gap-1"><ChefHat className="w-4 h-4" /> Specialties</Badge>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                    <span className="text-lg font-medium text-blue-600">{helper.name?.charAt(0) ?? "H"}</span>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">{helper.owner?.joinedDate ?? helper.lastUpdated}</div>
                  </div>
                </div>

                <div className="text-sm text-gray-600">{helper.owner?.responseTime ?? "Usually responds quickly"}</div>
